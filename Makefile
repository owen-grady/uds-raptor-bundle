...
download-rke2-tarballs: ## Download RKE2 Installation Tarballs
	curl -# -o $(CURDIR)/rke2-ansible/tarball_install/rke2-images.linux-amd64.tar.zst -L https://github.com/rancher/rke2/releases/download/$(RKE2_VERSION)/rke2-images.linux-amd64.tar.gz
	...
	curl -# -o $(CURDIR)/rke2-ansible/tarball_install/rke2-images-calico.linux-amd64.tar.zst  -L https://github.com/rancher/rke2/releases/download/$(RKE2_VERSION)/rke2-images-calico.linux-amd64.tar.gz
